# Contributing to Tokens Distribution
...
We really appreciate and value contributions to the Tokens Distribution Repository. Please review the items listed below to make sure that your contributions are merged as soon as possible.
...
Finally, if you're looking to collaborate and want to find easy tasks to start, look at the issues we marked as ["Good first issue"](https://github.com/wibsonorg/tokens-distribution/issues?q=is%3Aopen+is%3Aissue+label%3A%22good+first+issue%22).
...
[LGPL-3.0]: LICENSE
[Github Issues]: https://github.com/wibsonorg/tokens-distribution/issues
